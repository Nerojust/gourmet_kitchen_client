export const NAIRA = '₦';
export const NAIRA_ = '\u20a6';
export const WHATSAPP_NUMBER = '08186543390';
export const LIMIT_FIGURE = 5000;
export const DIALOG_TIMEOUT = 1100;
export const INVENTORY_LOW_COUNT = 20;
export const ACTIVE_OPACITY = 0.6;
export const ROUTER_ACTIVE_OPACITY = 0.5;
export const GOOGLEAPI_KEY = 'AIzaSyBeMiMQ-XEFp2jz_I80CMYD3GErVMDHJM4';
//export const GOOGLEAPI_KEY = "AIzaSyDPEzytcDTH18DQU3BXioxWY183FPDfr1A";
export const STORE_URL = 'https://stores.zupa.ng/zupastores';
